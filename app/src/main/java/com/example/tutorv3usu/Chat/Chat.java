...
import com.example.tutorv3usu.Adaptadores.MensajeAdaptador;
...
public class Chat extends AppCompatActivity {
    ...
    private final List<Mensajes> messageList = new ArrayList<>();
    private LinearLayoutManager linearLayoutManager;
    private MensajeAdaptador messageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageAdapter = new MensajeAdaptador(messageList);
       ...
       // fetchMessages();
        ...
        rootReference.child("Usuarios").child(messageReceiverID)
...
//                        }
                        ...
                        if (active_status.contains("true")){
                            chatUserActiveStatus.setText("Activo");
                        } else {
                ...
                .addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        if (dataSnapshot.exists()){
                            Mensajes message = dataSnapshot.getValue(Mensajes.class);
    ...
    private void sendMessage() {
        ...
        if (TextUtils.isEmpty(message)){
            SweetToast.info(Chat.this, "no hay nada");
        } else {
            ...
            rootReference.updateChildren(messageBodyDetails, new DatabaseReference.CompletionListener() {
                ...
                public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                    ...
                    if (databaseError != null){
                        Log.e("Error mensaje", databaseError.getMessage());
                    }
