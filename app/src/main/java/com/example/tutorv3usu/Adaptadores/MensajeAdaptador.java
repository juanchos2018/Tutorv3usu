...
public class MensajeAdaptador  extends RecyclerView.Adapter<MensajeAdaptador.MessageViewHolder> {
    ...
    public MensajeAdaptador(List<Mensajes> messageList) {
    ...
    public void onBindViewHolder(@NonNull  final MessageViewHolder holder, int position) {
        ...
        Mensajes message = messageList.get(position);
