package com.example.tutorv3usu.Info;
...
import com.example.tutorv3usu.MisDatos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userDatabaseReference.child(receiver_userID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String status = dataSnapshot.child("correo").getValue().toString();
                String profession = dataSnapshot.child("telefono").getValue().toString();
        ...
        if (!senderID.equals(receiver_userID)){ // condition for current owner / sender id
            ...
            go_my_profile.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Perfil.this, MisDatos.class);
