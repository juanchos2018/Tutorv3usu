...
import com.example.tutorv3usu.Modelo.Recibidos;
...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        request_list = vista.findViewById(R.id.requestList1);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Recibidos> recyclerOptions = new FirebaseRecyclerOptions.Builder<Recibidos>()
                .setQuery(databaseReference, Recibidos.class)
                .build();

        FirebaseRecyclerAdapter<Recibidos, RequestsVH> adapter = new FirebaseRecyclerAdapter<Recibidos, RequestsVH>(recyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull final RequestsVH holder, int position, @NonNull Recibidos model) {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        if (which == 2){
                                                            Intent profileIntent = new Intent(getContext(), Perfil.class);
                            ...
                            if (requestType.equals("sent")){
                                ...
                                userDatabaseReference.child(userID).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        final String userVerified = dataSnapshot.child("verified").getValue().toString();
                                        final String userThumbPhoto = dataSnapshot.child("user_thumb_image").getValue().toString();
                                        final String user_status = dataSnapshot.child("apellido").getValue().toString();
